...
btn6.addEventListener("click", ()=>{
  var organicAshw = document.getElementById("organicAshw").textContent;
  organicAshw = organicAshw.split(" ");
  // console.log(organicAshw)
  var price = organicAshw[2];
  ...
  var caplets = document.getElementById("caplets");
  caplets.innerHTML = caplet;

  var totQuan = `${quantity} x ${price}`
